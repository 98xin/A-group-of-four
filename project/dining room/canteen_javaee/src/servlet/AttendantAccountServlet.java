...
/**
 * Servlet implementation class AttendantAccountServlet
 */
@WebServlet("/AttendantAccountServlet")
public class AttendantAccountServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AttendantAccountServlet() {
        super();
		...
		// TODO Auto-generated method stub
				...
				if("".equals(userName) || "".equals(passWord)) {
					...
					if(b == false) {
						...
						attendantBean.setAttendantName(userName);
						attendantBean.setAttendantPassword(passWord);
						attendant.insertAttendant(attendantBean);
						JSONObject json = new JSONObject();
